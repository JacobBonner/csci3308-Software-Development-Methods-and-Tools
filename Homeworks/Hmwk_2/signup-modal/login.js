function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        // ASK ABOUT: "Password and Confirm Password Match" changes from red to green after lower case is entered in the password field. If they dont match, 
        //             it needs to move from green to red.
...
function enableButton(letter, capital, number, length, match) {
    ...
    if(condition) {       
        ...
        // ASK ABOUT ADDING THE ELSE CONDITION
    // else{
